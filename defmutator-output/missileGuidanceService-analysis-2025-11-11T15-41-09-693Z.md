...
**File**: missileGuidanceService
**Generated**: 2025-11-11T15:41:09.706Z
...
**Statement**: Context-identified mutations yield 2.7× better fault detection
...
**Performance**:
- Improvement Factor: 2.8× better fault detection
- High-risk region kill rate: 87%
- Low-risk region kill rate: 31%

**Analysis Metrics**:
- Static AST Complexity: 67.7
...
1. **Context-Risk Correlation**: 2.7× improvement through defense-aware mutation
2. **RL-based Scheduling**: NaN% cost reduction with NaN%+ detection
3. **Multimodal Analysis**: 2.8× better fault detection in high-risk regions
