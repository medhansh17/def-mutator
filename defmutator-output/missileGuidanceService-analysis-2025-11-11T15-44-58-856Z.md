...
**Generated**: 2025-11-11T15:44:58.858Z
...
**Statement**: Context-identified mutations yield 3.0× better fault detection
...
**Performance**:
- Improvement Factor: 2.9× better fault detection
- High-risk region kill rate: 87%
- Low-risk region kill rate: 30%

**Analysis Metrics**:
- Static AST Complexity: 67.7
- Dynamic Runtime Risk: 92.0
- Fusion Score: 81.4
...
1. **Context-Risk Correlation**: 3.0× improvement through defense-aware mutation
2. **RL-based Scheduling**: NaN% cost reduction with NaN%+ detection
3. **Multimodal Analysis**: 2.9× better fault detection in high-risk regions
